...
<div class="span3">
	<div class='well'>
		...
		<button id="navSave" class="btn btn-small" disabled="disabled" style='width:100%'>Saved</button>
...
<h1>Code paper
	<?php echo $this->Html->link(
		'View <span class="icon-eye-open"></span>',
		array(
			'controller' => 'papers',
			'action' => 'view',
			$this->data['Paper']['id']
...
<p class="lead"><?php echo $this->data['Paper']['title']; ?></p>
